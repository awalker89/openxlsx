...
\noindent
The openxlsx package requires a zip application to be available to R. On windows the simplest way to set this up is to install Rtools:  https://cran.r-project.org/bin/windows/Rtools/  \\
