#' A class to contain the (meta)data of an excel workbook.
#'
#' @slot charts  Charts contained therein.
#' @slot isChartSheet If this is not annoying, I will include docstrings elsewhere.
#'
